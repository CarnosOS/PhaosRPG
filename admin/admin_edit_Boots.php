...
<html>
<head>
<title>WoP Admin Panel - Edit Boots</title>
...
<table width="600" border="1" cellspacing="0" cellpadding="3" align="center">
  ...
  <tr> 
	...
	<?php
	$self=mysql_query("SELECT * FROM phaos_boots");
...
echo "<tr><td><a href='change_boots.php?boots=$id'><b>$id - $desc</b></a></td><td>$ac</td><td>&nbsp;&nbsp;</td><td>".number_format($buy)."</td><td>&nbsp;&nbsp;</td><td>".number_format($sell)."</td></tr>";
} 
	?>
	</table></td>
  </tr>
