...
<html>
<head>
<title>WoP Admin Panel - Edit Armor</title>
...
<table width="600" border="1" cellspacing="0" cellpadding="3" align="center">
  ...
  <tr> 
	...
	<?php
	$self=mysql_query("SELECT * FROM phaos_armor");
    while ($row = mysql_fetch_array($self)) {
        ...
        $buy = $row['buy_price'];
        $sell = $row['sell_price'];
        echo "<tr><td><a href='change_armor.php?armor=$id'><b>$id - $desc</b></a></td><td>$ac</td><td>&nbsp;&nbsp;</td><td>".number_format($buy)."</td><td>&nbsp;&nbsp;</td><td>".number_format($sell)."</td></tr>";
} 
	?>
	</table></td>
  </tr>
